...
$sql = "SELECT *  FROM registro_fichajes";
...
<head>
    ...
    <link rel="stylesheet" href="../css/estilo-fichajes.css">
...
<body>
    ...
    <div class="contenedor">
        ...
        <h1 class="title-reg">Regístro Jugadores Fichados</h1>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th class="columna campo"><?php echo $row['fecha_compra'] ?></th>
