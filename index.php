...
<body>
    ...
    <div class="main-equipo">
        ...
        <div class="container">
            ...
            <a href="Fichajes_New_Castle/index.php" class="caja caja3-equipo">
                <!-- Contenido de la izquierda -->
                <h3>Fichajes</h3>
            </a>
            <a href="Traspasos_New_Castle/index.php" class="caja caja4-equipo">
    ...
    <div class="main-jugadores">
        <h3>JUGADORES</h3>
        <div class="container">
            <a href="Registros_Dani/player.php" class="caja caja1-jugador">
                <!-- Contenido de la izquierda -->
                <h3>Daniel Rincón</h3>
            </a>
            <a href="Registros_Riviere/player.php" class="caja caja2-jugador">
                <!-- Contenido de la derecha -->
                <h3>Riviere</h3>
            </a>
